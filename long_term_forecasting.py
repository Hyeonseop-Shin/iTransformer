...
class Long_Term_Forecast():
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            valid_loss = self.validation(valid_data, valid_loader, criterion)
            # test_loss = self.validation(test_data, test_loader, criterion)
    ...
    def test(self, setting, test=0):
        ...
        with open(f"./results/result_long_term_forecast.txt", 'a') as f:
            f.write(setting + "  \n")
